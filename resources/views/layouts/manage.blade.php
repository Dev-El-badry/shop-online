...
<html lang="{{ app()->getLocale() }}">
  <head>
    ...
    <!-- <link rel="stylesheet" href="{{ asset('css/dist/rt/AdminLTE.min.css') }}"> -->
  ...
  <body class="skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2018 <a href="#">Eslam Elbadry</a>.</strong> All rights reserved.
      </footer>
