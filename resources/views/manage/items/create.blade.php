      ...
      <div class="box">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control width-small" id="item_qty" name="item_qty" placeholder="{{ trans('items.item_qty') }}" value="{{ old('item_qty') }}">
          </div>
        </div>
         ...
         @endphp
          ...
          <div class="col-sm-10">
            ...
            {!! Form::select('discount', $options_discount, '', ['class'=>'form-control  width-small']) !!}
          </div>
        </div>
